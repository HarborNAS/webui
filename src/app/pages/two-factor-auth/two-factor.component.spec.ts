...
describe('TwoFactorComponent', () => {
    ...
    providers: [
      ...
      mockProvider(AuthService, {
        ...
        userTwoFactorConfig$: of({
          provisioning_uri: 'somepath://here/HarborNAS:first-test?secret=KYC123',
          interval: 30,
          otp_digits: 6,
          secret_configured: true,
  ...
  it('shows the QR code viewer with correct provisioning URI when 2FA is configured', () => {
    ...
    expect(qrViewer).toHaveProperty('qrInfo', 'somepath://here/HarborNAS:first-test?secret=KYC123');
  });
