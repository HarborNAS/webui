...
export const failoverDisabledReasonLabels = new Map<FailoverDisabledReason, string>([
  ...
  [FailoverDisabledReason.NoSystemReady, T('Other HarborNAS controller has not finished booting.')],
  [FailoverDisabledReason.NoPong, T('Other HarborNAS controller cannot be reached.')],
  [FailoverDisabledReason.NoFailover, T('Failover is administratively disabled.')],
  [FailoverDisabledReason.NoLicense, T('Other HarborNAS controller has no license.')],
  [FailoverDisabledReason.DisagreeVip, T('Nodes Virtual IP states do not agree.')],
  [FailoverDisabledReason.MismatchDisks, T('The HarborNAS controllers do not have the same quantity of disks.')],
  [FailoverDisabledReason.MismatchVersions, T('HarborNAS software versions do not match between storage controllers.')],
