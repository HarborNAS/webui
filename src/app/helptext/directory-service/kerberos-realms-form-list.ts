...
export const helptextKerberosRealms = {
  ...
  primaryKdcTooltip: T('The master Kerberos domain controller for this realm. HarborNAS uses this as a fallback if it cannot get credentials because of an invalid password. This can help in environments where the domain uses a hub-and-spoke topology. Use this setting to reduce credential errors after HarborNAS automatically changes its machine password.'),
};
