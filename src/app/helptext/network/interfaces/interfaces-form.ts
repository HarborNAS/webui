...
export const helptextInterfacesForm = {
 ...
 on this HarborNAS controller. The alias can be an IPv4 or IPv6 \
 address.'),
 ...
 on the other HarborNAS controller. The alias can be an IPv4 or IPv6 address.'),
      virtualAliasAddressTooltip: T('Define an alias that can \
 connect to the interface on either HarborNAS controller. This address \
